...
pub enum PackageError {
    #[serde(rename = "dev.thmsn.build_info.extract.package.error.metadata")]
    #[error("Failed to load package metadata: {inner_error}")]
    Metadata { inner_error: AnyError },
    #[serde(rename = "dev.thmsn.build_info.extract.package.error.resolve")]
    #[error("Failed to resolve package")]
    Resolve,
    #[serde(rename = "dev.thmsn.build_info.extract.package.error.root_package")]
    #[error("Failed to resolve root package with id {id}")]
    RootPackage { id: String },
    #[serde(rename = "dev.thmsn.build_info.extract.package.error.root_package_id")]
    #[error("Failed to resolve root package ID")]
    RootPackageId,
    #[serde(rename = "dev.thmsn.build_info.extract.package.error.serialize")]
